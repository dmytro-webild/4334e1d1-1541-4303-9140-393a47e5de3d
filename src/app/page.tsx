...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      carouselItems={[
        {
          id: "1",
          imageSrc: "http://img.b2bpic.net/free-photo/african-american-male-programmer-working-cloud-computing-with-algorithm_482257-120315.jpg",
          imageAlt: "Tech Dashboard",
        },
        {
          id: "2",
          imageSrc: "http://img.b2bpic.net/free-vector/landing-page_52683-6021.jpg",
        ...
        {
          id: "5",
          imageSrc: "http://img.b2bpic.net/free-psd/flat-design-home-deco-template_23-2149498712.jpg",
          imageAlt: "UI Elements",
        },
        {
          id: "6",
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "We bridge the gap between ",
        },
        {
          type: "image",
        ...
        {
          type: "text",
          content: " vision and technical execution.",
        },
      ]}
      buttons={[
        {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/african-american-remote-worker-uses-chroma-key-screen-gadget_482257-121486.jpg",
        },
        {
          id: "f3",
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          price: "HIPAA Ready",
          variant: "Mobile",
          imageSrc: "http://img.b2bpic.net/free-photo/hospital-cross-health-treatment-icon-graphic-concept_53876-120435.jpg",
        },
        {
          id: "p6",
          ...
          price: "Award Winning",
          variant: "Portfolio",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-graphic-design-studio_23-2151320743.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah Chen",
          role: "CEO",
          testimonial: "The performance boost they delivered was immediate.",
        ...
        },
        {
          ...
          name: "Mark Roberts",
          role: "Product Lead",
          testimonial: "Exceptional communication and attention to detail throughout the cycle.",
        ...
        },
        {
          ...
          name: "Emily Zhao",
          role: "CTO",
          testimonial: "Their engineering team is world-class, truly transformed our platform.",
        ...
        },
        {
          ...
          testimonial: "Increased our lead flow by 50% within the first quarter.",
        ...
        },
        {
          ...
          name: "Jessica Lee",
          role: "Founder",
          testimonial: "The best technical partner we've had in 5 years of startup operations.",
      ...
      faqs={[
        {
          ...
          content: "Projects usually range from 6 to 12 weeks depending on the complexity of the requirements.",
        },
        {
          id: "q2",
          title: "Do you provide maintenance?",
          content: "Yes, we offer ongoing maintenance and support packages post-launch.",
        },
        {
          id: "q3",
          title: "How do we communicate?",
          content: "We use standard project management tools and hold bi-weekly sync meetings to keep everyone aligned.",
        },
      ]}
